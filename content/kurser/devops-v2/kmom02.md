...
Nu ska ni själva implementera playbooks för att sätta upp microbloggen på båda appservrarna och en mysql databas på databasservern.
...
1. I Azure ska ni ha strukturen med fyra VMs, en Load balancer, två app servrar och en databas server. Site.yml playbook:en ska kunna sätta upp hela miljön från inget till klar.
