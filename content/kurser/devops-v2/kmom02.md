...
1. https://developer.cyberark.com/blog/devops-dishwasher/
...
3. Vad är fördelarna med IaC och CM jämfört med att sätta upp allt manuellt?

4. Vad är Continuous Deployment?

5. Kan du se några problem med vår CI/CD kedja (tänk hur den skulle sätt ut om Azure hade funkat för oss)?

6. Om du fick välja fritt hur skulle du vilja bygga upp CD kedjan?

7. Hur var storleken på kursmomentet? Har du haft tid över så att du hade hunnit med att driftsätta via Github Actions?
